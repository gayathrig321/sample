...
<div class="panel panel-primary">
 ...
 <button id="btn_add" name="btn_add" class="btn btn-default pull-right">Add New Product</button>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
           <div class="modal-content">
            ...
            <button type="button" class="btn btn-primary" id="btn_my_btn" value="add">Save changes</button>
  ...
  <div>
        <button type="button" class="btn btn-primary" id="btn_my_btn1" value="add">Save</button>
            <input type="hidden" id="product_id" name="product_id" value="0">    
  </div>
